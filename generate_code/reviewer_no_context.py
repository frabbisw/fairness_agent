...
prompt_styles = {
    "gpt": {
      ...
      Given PROMPT and GENERATED_CODE (one method), identify which attributes used in GENERATED_CODE are not justified by the PROMPT for making the decision. 
      Remove only the unjustified attribute dependence with minimal substring edits. 
      Output ONLY JSON: {"edits":[{"op":"replace","old":"...","new":"..."},{"op":"delete","old":"..."}]}. "old" MUST be an exact substring of GENERATED_CODE. 
